...
Revision ID: 514a634683ab
Revises: 61c58638e56b
Create Date: 2024-06-28 15:47:20.727702
...
def upgrade():
    ...
    op.create_table(
        "agency_contact_info",
        sa.Column("agency_contact_id", sa.BigInteger(), nullable=False),
        ...
        sa.PrimaryKeyConstraint("agency_contact_id", name=op.f("agency_contact_info_pkey")),
        schema="api",
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["api.agency_contact_info.agency_contact_id"],
    ...
    op.create_index(
        op.f("agency_agency_code_idx"), "agency", ["agency_code"], unique=False, schema="api"
    )
    op.create_table(
